...
- 46~61번은 기존 주제에서 약했던 **모바일 플랫폼 통합**(46·47·48·56·57·58), **온디바이스 AI**(50), **데이터·콘텐츠 파이프라인 및 그래픽/UI 보강**(49·51·52·59·61), **아키텍처·인프라 보강**(53·54·55)을 추가한 주제다. 선행 학습 자료 URL은 2026-06 기준 공식 문서로 확인했다. Sentis는 현재 `com.unity.ai.inference`(Inference Engine)로 패키지명이 바뀌었다.
